...
#surfaces = gmsh.model.occ.fuse([surfaces_index.pop(0)], surfaces_index, removeObject=True, removeTool=True)
...
#gmsh.model.occ.cut([(2, surfaces)],[(2, holes)], removeObject=True, removeTool=True)
gmsh.model.occ.synchronize()
gmsh.model
